...
import type { AnyBooking, RestaurantBookingStatus } from "../../../pages/RestaurantAdmin/types";
import { formatDate } from "../../../pages/RestaurantAdmin/utils";

export const AllBookingsTable: React.FC<{ bookings: AnyBooking[] }> = ({ bookings }) => {
        ...
        <table className="w-full min-w-[760px] text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {filtered.length === 0 ? (
              ...
              filtered.map((b) => (
                <tr key={b.booking_id} className="transition-colors hover:bg-secondary-50">
