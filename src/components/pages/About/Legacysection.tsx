import { LEGACY_DATA } from "../../../data/about/legacy/legacy.data";

const LegacySection = () => {
  return (
    <section className="section-padding bg-white px-4 py-16 md:px-8 lg:px-16 lg:py-24">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block p-3 bg-primary-100 rounded-lg mb-6">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth={0}
            ...
            <div className="space-y-4 text-gray-600">
              {LEGACY_DATA.paragraphs.map((paragraph) => (
