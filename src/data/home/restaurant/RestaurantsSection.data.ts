import GurugramImage from "../../../assets/images/Restaurents/gurugram.webp"
import NoidaImage from "../../../assets/images/Restaurents/noida.webp"
import IndoreImage from "../../../assets/images/Restaurents/indore.webp"

import GurugramMenu from "../../../assets/Menus/Malabar-Coast-Gurugram-Menu.pdf"
import NoidaMenu from "../../../assets/Menus/Malabar-Coast-Noida-Menu.pdf"
...
export const OUTLETS: Outlet[] = [
  {
    ...
    gallery: [GurugramImage],
    menus: {
      food: GurugramMenu,
      mocktail: MocktailMenu,
      kittyParty: KittyPartyMenu,
    },
    menu: "gurgaon-",
    reservations: {
    ...
    description: "Welcome to The Malabar Coast, proudly regarded as the best South Indian restaurant in Gurgaon, serving authentic Kerala food and coastal delicacies inspired by the rich culinary heritage of India's southern shores. Set in M3M Atrium, Sector 57, we bring you the bold, aromatic flavours of the coast — from Kerala's tranquil backwaters to the fiery kitchens of Mangalore, Chettinad, Andhra, Tamil Nadu and Goa. Begin with our Prawn Andhra Chilli Fry or a crisp dosa with sambar and chutney, savour the Mangalorean fish curry with soft Malabar parotta, and round it off with chicken ghee roast and neer dosa, a wholesome banana leaf meal, or a delicate pomfret tawa fry. Every dish is made with traditional recipes and fresh, house-made masalas, promising an unforgettable coastal journey in the heart of Gurugram.",
  ...
  },
  {
    ...
    isOpen: true,
    specialtyTags: ['Family Dining', 'Authentic coastal cuisine'], // vibes, topTags
    description: "Welcome to The Malabar Coast, proudly regarded as the best South Indian restaurant in Noida, serving authentic Kerala food and coastal delicacies inspired by the rich culinary heritage of India's southern shores. Located at COWRKS, Sector 62, we bring you the bold, aromatic flavours of the coast — from Kerala's tranquil backwaters to the fiery kitchens of Mangalore, Chettinad, Andhra, Tamil Nadu and Goa. Begin with our Prawn Andhra Chilli Fry or fresh idly, savour the Mangalorean fish curry with soft Malabar parotta, and round it off with chicken ghee roast and neer dosa, or a crisp dosa with sambar and chutney and a delicate pomfret tawa fry. Every dish is made with traditional recipes and fresh, house-made masalas, promising an unforgettable coastal journey in the heart of Noida.",
  ...
  },
  {
    ...
    description: "Welcome to The Malabar Coast at Phoenix Citadel Mall, Indore's destination for authentic Kerala food and coastal Indian cuisine. We bring you the bold, aromatic flavours of India's coastal kitchens — from Kerala's tranquil backwaters to the fiery tastes of Mangalore, Chettinad, Andhra, Tamil Nadu and Goa. Our menu features handpicked regional favourites: Mangalorean fish curry, chicken ghee roast with neer dosa, fiery Andhra chilli chicken, vegetable stew with idiyappam, Malabar parotta with Chettinad mutton, pomfret tawa fry, and Thalassery chicken biryani. Every dish is made using traditional recipes, fresh seafood, and house-made masalas, delivering an authentic coastal experience in every bite.",
...
export const SOCIAL_LINKS = [
  ...
  // { label: "Twitter", href: "", icon: "M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z" },
