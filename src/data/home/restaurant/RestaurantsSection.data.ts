...
export const OUTLETS: Outlet[] = [
  {
    ...
    description: "Welcome to The Malabar Coast, one of the best South Indian restaurants in Gurgaon, serving authentic Kerala cuisine and coastal delicacies inspired by the rich flavours of India’s southern shores. From Kerala and Mangalore to Chettinad, Andhra, Tamil Nadu and Goa, our menu celebrates bold spices, traditional recipes and soulful comfort food. 🌴 Our Must-Try Specialities Prawn Andhra Chilli Fry Mangalorean Fish Curry with Malabar Parotta Chicken Ghee Roast with Neer Dosa Crispy Dosa with Sambar & Chutney Traditional Banana Leaf Meal Pomfret Tawa Fry Whether you are craving authentic Kerala food, traditional South Indian cuisine, fresh seafood, coastal delicacies, or comforting vegetarian favourites, We offers something for every palate.",
  ...
  },
  {
    ...
    isOpen: true,
    specialtyTags: ['Family Dining', 'Authentic coastal cuisine'], // vibes, topTags
    description: "Welcome to The Malabar Coast, one of the best South Indian restaurants in Noida, serving authentic Kerala cuisine and coastal delicacies inspired by the rich flavours of India’s southern shores. From Kerala and Mangalore to Chettinad, Andhra, Tamil Nadu and Goa, our menu celebrates bold spices, traditional recipes and soulful comfort food. 🌴 Our Must-Try Specialities Prawn Andhra Chilli Fry Mangalorean Fish Curry with Malabar Parotta Chicken Ghee Roast with Neer Dosa Crispy Dosa with Sambar & Chutney Traditional Banana Leaf Meal Pomfret Tawa Fry Whether you are craving authentic Kerala food, traditional South Indian cuisine, fresh seafood, coastal delicacies, or comforting vegetarian favourites, We offers something for every palate.",
  ...
  },
  {
    ...
    description: "Welcome to The Malabar Coast, one of the best South Indian restaurants in Indore, serving authentic Kerala cuisine and coastal delicacies inspired by the rich flavours of India’s southern shores. From Kerala and Mangalore to Chettinad, Tamil Nadu and Goa, our menu celebrates bold spices, traditional recipes and soulful comfort food. 🌴 Our Must-Try Specialities Prawn Masala Tawa Fry Mangalorean Fish Curry with Malabar Parotta Chicken Ghee Roast with Neer Dosa Crispy Dosa with Sambar & Chutney Traditional Banana Leaf Meal Pomfret Tawa Masala Fry Whether you are craving authentic Kerala food, traditional South Indian cuisine, fresh seafood, coastal delicacies, or comforting vegetarian favourites, We offers something for every palate.",
...
export const RESTAURANTS_HEADER_DATA = {
  ...
  description: `Discover ${OUTLETS.length} Unique Dining Experiences Across ${RESTAURANT_CITY_FILTERS.length - 1} Cities Each outlet has its own character, vibe, and specially curated menu.`,
