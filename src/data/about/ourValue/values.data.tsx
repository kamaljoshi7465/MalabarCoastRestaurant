...
export const VALUES: Value[] = [
  ...
  },
  {
    ...
    title: "Passion",
    description:
      "Every dish is crafted with love and dedication to excellence",
    icon: <HeartIcon />,
  },
  {
    id: 3,
    title: "Community",
    description:
      "Building connections through shared meals and cultural experiences",
    icon: <UsersIcon />,
  },
  {
    id: 4,
    title: "Excellence",
    description:
      "Committed to the highest standards in food quality and service",
    icon: <AwardIcon />,
  },
];